...
function addAutoReplyButton(replyArea, emailBodyArea) {
  ...
  var autoReplyButton = document.createElement("button");
  ...
  autoReplyButton.addEventListener('click', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 5:
          prompt = "Create a reply email without subject for this email content: " + emailContent;
          console.log(prompt);
          try {
...
var observer = new MutationObserver(function (mutations) {
  mutations.forEach(function (mutation) {
    ...
    var replyArea = document.querySelector('form[class="bAs"]');
    //This element is to differentiate new message window and reply window
    var newMsgEl = document.querySelector('div[class="aYF"]');
    ...
    if (!newMsgEl && replyArea && bodyInput && !document.querySelector("#autoReplyButton")) {
      ...
      (0,_auto_reply_js__WEBPACK_IMPORTED_MODULE_4__.addAutoReplyButton)(replyArea, bodyInput);
    }
  });
});

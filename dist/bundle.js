...
function _generateEmailContent() {
  _generateEmailContent = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(prompt) {
    var subjectArea, emailBodyArea, emailContent, _emailContent$split, _emailContent$split2, subject, bodyParts, body;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          subjectArea = document.querySelector('input[name="subjectbox"]');
...
function addPolishButton(subjectArea) {
  ...
  // Create the button
  var polishButton = document.createElement("button");
...
function openPromptPopup() {
  ...
  var selectedStyleMessage = document.createElement("p");
  selectedStyleMessage.style.marginTop = "10px";
  selectedStyleMessage.style.fontStyle = "italic";
  selectedStyleMessage.textContent = "Selected style: ".concat(selectedStyle);
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          prompt = "\n        Please polish the following email content in a ".concat(selectedStyle.toLowerCase(), " style for clarity and professionalism. Return a single, complete email template, without repeating sections, and ensure it is ready to be sent. Do not include extra notes, suggestions, or alternative templates.\n        ").concat(userInput ? "Additional instructions: " + userInput : "", "\n        ").concat(existingText, "\n        "); // Show loading message
...
// async function callAIPromptAPI(prompt) {
//     try {
//         const { available } = await ai.languageModel.capabilities();
//         if (available !== "no") {
//             const session = await ai.languageModel.create();
//             const result = await session.prompt(prompt);
//             // Result contains three subjects separated by new lines or semicolons
...
//         return ["Error occurred while generating subjects."];
//     }
// }

function addCreateSubjectButton(subjectInput, bodyInput) {
...
var observer = new MutationObserver(function (mutations) {
  mutations.forEach(function (mutation) {
    var subjectArea = document.querySelector('input[name="subjectbox"]');
    var subjectElement = document.querySelector("h2.hP");
    var bodyInput = document.querySelector('.Am.Al.editable');
    ...
    if (subjectArea && !document.querySelector("#autoWriteButton")) {
      ...
      (0,_auto_write_js__WEBPACK_IMPORTED_MODULE_0__.addAutoWriteButton)(subjectArea);
    }
    ...
    if (subjectElement && !document.getElementById("summarize-button")) {
      ...
      (0,_summarize_js__WEBPACK_IMPORTED_MODULE_1__.addSummarizeButton)(subjectElement);
    }
    ...
    if (subjectArea && !document.querySelector("#polishButton")) {
      ...
      (0,_polish_js__WEBPACK_IMPORTED_MODULE_2__.addPolishButton)(subjectArea);
    }
    ...
    if (subjectArea && bodyInput && !document.querySelector("#create-subject-button")) {
      ...
      (0,_subject_js__WEBPACK_IMPORTED_MODULE_3__.addCreateSubjectButton)(subjectArea, bodyInput);
    }
  });
});
